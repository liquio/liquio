...
// than its own shipped .d.ts describes — the same real version/types
// mismatch documented in SelectFileArea/index.tsx.
...
class FileInputField extends Component<FileInputFieldProps, FileInputFieldState> {
  ...
  renderBody = ({
    ...
    getInputProps?: (params: Record<string, unknown>) => Record<string, unknown>;
  } = {}) => {
...
export default withStyles(styles)(FileInputField as never) as unknown as React.ComponentType<
