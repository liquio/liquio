...
const FileModal = (props: FileModalProps) => {
  ...
  const getFile = React.useMemo(() => {
    return () => {
      ...
      return (fileStorage || {})[item.id as string] || (fileStorage || {})[item.downloadToken as string];
    };
...
export default translate('TaskPage')(FileModal as never) as unknown as React.ComponentType<
