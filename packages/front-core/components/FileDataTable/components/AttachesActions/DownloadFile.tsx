...
const DownloadFile = ({ item, t, handleDownloadFile, downloadIcon, onPreviewError }: DownloadFileProps) => {
...
export default translate('WorkflowPage')(DownloadFile as never) as unknown as React.ComponentType<
