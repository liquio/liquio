...
import FileNameRaw from 'components/Attach/FileName';
import renderHTML from 'helpers/renderHTML';

const FileName = FileNameRaw as unknown as React.ComponentType<Record<string, unknown>>;
...
export default withStyles(styles)(FileNameColumn as never) as unknown as React.ComponentType<
