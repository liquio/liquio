...
const SelectComponent = React.memo((props: CustomSelectCellProps) => {
  ...
  return (
    <FormControl className={classes.formControl}>
      <Select
        ...
        {...({ isDisabled: columnData.disabled } as unknown as Record<string, unknown>)}
...
const selectColumn = (options: ColumnData) => ({
  ...options,
