...
const months = (t: (key: string) => string) => [
  {
    id: '01',
    name: t('January'),
  },
...
interface UserInputFieldsProps {
  ...
  handleCallIndexReader?: (value: unknown) => void;
  readerError?: string | boolean;
    ...
    <>
      ...
      {readerError && (
        ...
        >
          ...
          <p className={classes.attentionText}>{renderHTML(t(readerError as string))}</p>
        </div>
      )}
