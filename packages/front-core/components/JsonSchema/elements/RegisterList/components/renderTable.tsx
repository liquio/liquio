...
const TableComponent = ({
  ...
  const RenderCell = React.useCallback(
    ({
      ...
      const filterValue = requestFilters[column?.id as string] || '';
        ...
        >
          ...
          {filter ? (
            <StringElement
              ...
              onChange={(value: unknown) => handleSearch(id, value)}
              endAdornment={
  ...
  const onRowClickWrapper = React.useCallback(
    (row: Record<string, unknown>) => {
      ...
      window.location.href = evaluateValue as string;
    },
    [onRowClick],
  );
