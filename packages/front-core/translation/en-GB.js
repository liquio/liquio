...
export default {
  locale: 'en',
  App: {
    DeletePagePrompt: 'Are you sure you want to leave this page?',
    DeletePagePromptDescription:
      'Are you sure you want to delete the step "{{name}}"? You can restore it by pressing Ctrl+Z',
    ...
    NoEnableUnit: 'You do not have access to the environment',
    'NoEnableUnit subtitle': 'Please contact the system administrator',
  },
  FileLibrary: {
    ...
    UploadProgress: '{{completed}} of {{total}} files uploaded',
    Folder: 'Folder',
    Name: 'Name',
    Type: 'Type',
    Access: 'Access',
    ...
    DeleteItemDescription: 'Are you sure you want to delete this item?',
    DeleteSelectedDescription: 'Are you sure you want to delete {{count}} selected items?',
  ...
  MessageTemplatesList: {
    ...
    Cancel: 'Close',
    Save: 'Save',
    DublicateTemplateTitle: 'Duplicate IDs',
    ...
    Recomend: 'You can overwrite the template or save it with a new ID.',
  ...
  Navigator: {
    ...
    EmptyDescription:
      'Refine your search or contact the administrator to create the required tag.',
  },
  TaskListPage: {
  ...
  TaskPage: {
    ...
    LiquioServerSignDialogTitle: 'Sign document',
    LiquioServerSignDialogText: 'Confirm signing this document.',
    LiquioServerSignButton: 'Sign',
    ...
    AdditionalHash: 'Attachment hash',
    AsyncModalText: 'The data is being processed. This may take a few minutes. Please wait for the result.',
    AsyncModalTitle: 'Loading',
    AsyncReaderErrorText:
      'An unexpected error occurred. Please go back to the previous step or submit the request again. If the problem persists, contact support.',
    AttachmentSign: 'Application attachments',
    AttachmentsPdf: 'Additional files',
    BackToStartOfPdf: 'Back to the beginning of the PDF content',
    BuildingErrorText: 'May contain letters of the Ukrainian alphabet, digits, and punctuation marks',
    ChangeAssign: 'Change performer',
    ContinueEditing: 'Continue editing',
    CreateNewDraft: 'Start over now',
    DeleteDraft: 'The entered data is no longer valid, you need to create a new record',
    DeleteDraftTimer: 'The entered data will be automatically deleted in {{timer}}',
    ErrorMessageReassigned: 'The task performer has changed. You no longer have access to it.',
    FailCreatingTask: 'The service order link is invalid or temporarily unavailable',
    FileLoadingError: 'The uploaded file was not found',
    GoToTask: 'To the selected service',
    GoToWorkflow: 'Back',
    IdCardErrorText: 'Must contain 9 digits',
    IndexFieldErrorText: 'Must contain 5 digits',
    IndexFieldErrorText1: 'Invalid index',
    IndexFieldErrorText2: 'The index does not match the address. Please make sure the index is correct',
    Manifest: 'List of files to sign',
    OneDraftAllowedText:
      '<h2>🤷‍♂️ You already have a draft for this service.</h2><h3>To create a new request, please delete the existing drafts first or click “Continue editing”.</h3>',
    PassportCardErrorText: 'Must contain 2 letters',
    PassportCardErrorText1: 'Invalid number. The number must contain 6 digits',
    PassportIssueDateErrorText: 'Correct the issue date; it cannot be later than the current date',
    PassportIssueDateErrorText1: 'The passport issue date cannot be earlier than 1994',
    PassportIssueDateErrorText2: 'The passport cannot be obtained before the age of 14',
    PassportIssueDateErrorText3: 'Non-leap year. February has only 28 days',
    PassportIssueDateErrorText4: 'The month has fewer days than you specified',
    PassportIssueDateErrorText5: 'The issue date cannot be later than 2018',
    PassportIssuedByErrorText: 'Must not be less than ten characters',
    PassportIssuedByErrorText1: 'Must not contain Latin letters or symbols',
    PassportIssuedByErrorText2: 'Must not contain more than one hyphen or one consecutive space',
    'Commit not available.': 'Sending is not available',
    ...
    "Error: Ipn from sign certificate not match user's ipn.":
      "Unable to complete signing. The electronic signature key does not match the user's IPN.",
    'Error: Only one draft allowed.': 'Error: only one draft is allowed',
    "Error: Signer doesn't have access to task before performer sign it.":
      'Please wait until the initiator signs the request.',
    "Sign certificate PEM not match user's PEM.":
      'You cannot sign the document with this key. Use the key you used to sign in.',
    'Signed content not match needed.': 'Signed content does not match the required content.',
    'Signed name not match needed.':
      "The full name in the electronic key does not match the user's full name.",
    SkipPdfContent: 'Skip the previous PDF content',
    StepNotConfigurated: 'The service is not configured',
    SuccesDialogText: 'Wait for other users to sign.',
    SuccesDialogTitle: 'You have signed the document successfully.',
    ToDrafts: 'To drafts',
    'User doesn’t have any access to task.': 'You do not have access to this request.',
    'User is not in signerUsers list.': 'The user is not in the signerUsers list.',
    'Workflow template not found.': 'Workflow not found.',
    PdfHash: 'Request hash',
    PdfPreviewZoom: 'Adjust PDF size',
    birthDateErrorText: 'The date of birth cannot be later than the current date',
    birthDateErrorText1: 'The month has fewer days than you specified',
    birthDateErrorText2: 'Non-leap year. February has only 28 days',
    birthDateErrorText3: 'You must be older than 14 years',
    birthDateErrorText4: 'Please check the passport or ID card issue date',
    birthDateErrorText5: 'The year of birth must be greater than 1900',
    chooseGender: 'Choose sex',
    ...
    foreignersDocumentExpireDateErrorText2: 'Non-leap year. February has only 28 days',
    foreignersDocumentIssueDateErrorText:
      'The issue date cannot be later than the current date. Please specify the exact date',
    foreignersDocumentIssueDateErrorText1: 'The issue date cannot be earlier than 2018',
    foreignersDocumentIssueDateErrorText2: 'The selected month has fewer days than you specified',
    foreignersDocumentIssueDateErrorText3: 'Non-leap year. February has only 28 days.',
    foreignersDocumentNumberErrorText: 'The number must contain 9 digits',
    foreignersDocumentNumberErrorText1: 'The number must contain 6 digits',
    foreignersDocumentNumberErrorText2: 'The number must start with 8',
    foreignersDocumentNumberErrorText3: 'The number must start with 9',
    foreignersDocumentSeriesErrorText: 'Must contain 2 letters',
    foreignersDocumentSeriesErrorText1: 'Can contain only letters',
    idCardExpiryDateErrorText: 'Your ID card has expired',
    idCardExpiryDateErrorText1: 'The month has fewer days than you specified',
    idCardExpiryDateErrorText2: 'Non-leap year. February has only 28 days',
    idCardIssueDateErrorText: 'Correct the issue date; it cannot be later than the current date',
    idCardIssueDateErrorText1: 'The ID card issue date cannot be earlier than 2016',
    idCardIssueDateErrorText2: 'The ID card cannot be obtained before the age of 14',
    idCardIssueDateErrorText3: 'Non-leap year. February has only 28 days',
    idCardIssueDateErrorText4: 'The month has fewer days than you specified',
    idCardIssuedByErrorText: 'Must contain 4 digits',
    unzrError: 'The number must contain 14 digits',
    unzrError1: 'Invalid number',
    unzrError2: 'Must contain 13 digits and a hyphen',
    userDataEmailError: 'This domain cannot be used to receive government services',
  },
  CreateTaskDialog: {
  ...
  Errors: {
    ...
    'Validation error': 'Validation error',
    AddToElasticFailed: 'Error adding elastic key "{{name}}"',
    AddToElasticSuccess: 'Successfully added elastic key "{{name}}"',
    CreatingMockSuccess: 'Mock created successfully',
    DeletingMockError: 'An error occurred while deleting the mock',
    DeletingMockSuccess: 'Mock deleted successfully',
    DocumentFinished: 'Document already finished',
    DraftExpired: 'Data is no longer valid, create a new record',
    ErrorCreatingMocks: 'Error creating mock',
    ErrorUpdatingMocks: 'Error updating mock',
    ExportErrorXLSX: 'An error occurred. Please try again',
    ExportRegistersSuccess: 'Key exported successfully',
    FailPutingRegistersAccessByStrictAccess:
      'strictAccess can be activated only when isPersonal is disabled',
    FailRestoringRecord: 'An error occurred while restoring the record',
    FailSetAdminTestUser: 'Assigning the administrator role to test users is forbidden',
    FailStoppingLoops: 'An error occurred while clearing loops',
    FailStoringRecordAllowTokens: 'The key schema contains fields with the allowTokens option',
    FailValidatingDocument: 'An error occurred, check the entered data',
    GetAddressError: 'Error getting address',
    ...
    RemoveFromElasticSuccess: 'Successfully removed elastic key "{{name}}"',
    SignaturesNotFound: 'Signatures not found',
    TagExists: 'A tag with this name already exists',
    TagNotCreated: 'Failed to create tag',
    TaskDeleted: 'Task deleted',
    TaskFinished: 'Task already finished',
    TaskSignaturesInvalid:
      'Unfortunately, an error occurred <br> Check signer data',
    'This document does not provide a P7S': 'This document does not provide a P7S signature.',
    'This key has been locked.': 'This key has been locked for editing',
    'WorkflowAdminPage.deadline_exists':
      'deadline has been moved to a separate configuration section - "Deadline"',
    'WorkflowAdminPage.setPermissions_exists':
      'setPermissions has been moved to a separate configuration section - "Performers and Signers"',
    WrongWorkflowId: 'Incorrect workflowId specified',
    phoneErrorText: 'The specified phone number is already registered'
  },
  Geolocation: {
  ...
  Elements: {
    ...
    NewValue: 'New value',
    Kind: 'Operation',
    ModifyTypeNew: 'Create',
    ModifyTypeDeleted: 'Delete',
    ModifyTypeAdded: 'Add',
    ModifyTypeEdit: 'Edit',
  ...
  TasksListSearch: {
    ...
    Status: 'Status',
    ClearAll: 'Clear all',
    FiltersNumber: '{{number}} filters selected',
  },
  SignForm: {
    sign: 'Signature',
    stamp: 'Stamp',
    ...
    "Error: EDRPOU from sign certificate not match user's EDRPOU.":
      "Unable to complete signing. The EDRPOU from the signature certificate doesn't match the initiator's EDRPOU.",
    ...
    'TaskPage.Сертифікат не знайдено (51)':
      'The encryption certificate needs to be updated. Please contact platform support.',
    '413 Payload Too Large': 'You are trying to sign a file that is too large',
  ...
  EJV: {
    ...
    HaveNoDepencies: 'No dependencies',
    MustBe: 'Must be {{cond}}',
  ...
  UserProfile: {
    ...
    EmailDomainError: 'Email with this domain cannot be used',
    ...
    PhoneDialogTextWithoutCode: 'Enter a new number:',
    PhoneInputLabelWithoutSMS: 'New phone number',
  ...
  WorkflowListAdminPage: {
    IgnoreErrorsAsk: 'Import without validation',
    Tags: 'Tags',
  ...
  TagsListPage: {
    ...
    UpdatedAt: 'Update Date',
    UpdatedBy: 'Updated by',
    SearchByTagNamePlaceholder: 'Search by tag name',
  ...
  DebugTools: {
    ...
    HashToInternal: 'Build signature',
    ...
    ExternalReaderMocks: 'Individual mocks',
    CheckSignData: 'Data for signing',
    Check: 'Check',
    Hash: 'Hash',
    Sign: 'Signature',
    Data: 'Data',
    SignData: 'Signature data',
    DecodedData: 'Decoded data',
    Signer: 'Signer',
    Decode: 'Decode',
    SearchMock: 'Search mocks',
    MockInitError: 'Mocks are not configured',
  ...
  UnitsListPage: {
    ...
    OverwriteUnitsConfirmationOne: 'Unit {{filesInfo}} already exists.',
    OverwriteUnitsConfirmationTextOne:
      'Are you sure you want to overwrite the existing unit?',
    CreatedAt: 'Created Date',
    UpdatedAt: 'Update Date',
    ...
    DeleteSystemUnit: 'Deleting a system unit is forbidden',
    ...
    LoadingCount: 'Loaded {{count}} units out of {{total}}',
  ...
  UnitPage: {
    ...
    Exemple: 'For example, /tasks',
    SystemEditName: 'Editing the system unit name is forbidden',
  ...
  ProcessesListPage: {
    ...
    AllSelected: 'Selected processes: {{count}}',
    AllSelectedAction: 'Select processes on all pages',
    ByLogId: 'Search by LogId',
    ByTraceId: 'Search by TraceId',
    ByUserId: 'Search by user',
    CancelBtn: 'No, do not delete',
    CheckAsNotErrorMassDescription:
      'Among the selected processes, {{count}} will have the error flag removed. Continue?',
    CheckAsNotErrorMassProcessing:
      'Marked as no error: {{value}} of {{count}}',
    CheckAsNotErrorMassTitle: 'Remove the error flag from processes',
    CheckAsNotErrorSuccess: 'Processes marked as "No Error"',
    ChoseRestartPoint: 'Choose a restart point',
    ClearLoops: 'Clear loops',
    ClearSelection: 'Clear selection',
    DeleteButton: 'Delete {{sign}}',
    DeleteSignPrompt: 'Are you sure you want to delete {{sign}}?',
    DeleteSignPromtDescription: 'This action is irreversible',
    ElasticError: 'Attention!',
    'Event already skipped.': 'Event already skipped.',
    ExportToPdf: 'Export to PDF',
    ExportToXlsx: 'Export to XLSX',
    RequiredField: 'Please select a value',
    RestartProcessFromPointTooltip:
      'Restart selected processes from a specific point',
    RestartPromptAllDescription:
      'You are restarting all processes that match the search parameters. Continue?',
    RestartPromptDescription:
      '{{count}} selected processes will be restarted',
    RestartPromptPointDescription:
      'Selected processes will be restarted from the selected point: {{point}}.',
    RestartPropmtDescription: 'Selected processes will be restarted',
    Sign: 'signature',
    SignDeleted: '{{sign}} deleted',
    Signs: 'signatures',
    SkipEventDescription: 'Skip execution of event {{event}}?',
    SkipEventTooltip: 'Skip',
    StopEvent: 'Attention',
    StopEventDescription: 'Stop execution of event {{event}}?',
    StopEventTooltip: 'Stop',
    'Workflow logs Elastic error.':
      'Advanced search is unavailable. Some filters will be disabled.',
    eventTemplateId: 'Event: {{value}}',
    gatewayTemplateId: 'Gateway: {{value}}',
    CreateNew: 'Create',
    Reindex: 'Reindex',
    restartFromPointDescription:
      'To restart from a point, you need to filter the processes by a single template',
    taskTemplateId: 'Task: {{value}}'
  },
  ...
  UserListPage: {
    ...
    OnboardingTaskId: 'Onboarding process ID',
    ...
    '{"error":"`password` is required"}': 'Password field is required',
    ...
    '...WorkflowProcesses': '...Workflow processes',
    ...WorkflowProcesses,
  ...
  JsonSchemaEditor: {
    ...
    Clear: 'Clear value',
    VoiceOverText: 'To clear the selected value, press the Delete or Backspace key',
    addItemText: 'Text to add an item',
  ...
  UserIdsFilterHandler: {
    ...
    Others: 'more {{length}}...',
    SaveWarningTitle: 'Warning',
    SaveWarningMessage: 'Using h1 and h2 headings is not allowed. Use h3–h6 level headings instead.',
  },
  WorkflowProcesses,
  ...
  UIFilterList: {
    ...
    Cancel: 'Cancel',
    'Invalid value': 'Invalid value',
    'tasks.my.opened': 'My active tasks',
    'tasks.my.closed': 'My closed tasks',
    'tasks.unit.opened': 'Unit active tasks',
    'tasks.unit.closed': 'Unit closed tasks',
    'workflows.not-draft': 'All processes (except drafts)',
    'workflows.draft': 'Drafts',
    'workflows.trash': 'Deleted processes',
    'workflows.not-draft.ordered-by-myself': 'Initiated by me',
    'workflows.not-draft.ordered-by-unit': 'Initiated by unit',
    'workflows.not-draft.observed-by-unit': 'Observed by unit',
  },
  InterfacesList: {
    CustomInterfaces: 'Interfaces',
    NewInterface: 'Create',
  ...
  CabinetMenuPage: {
    ...
    Enable: "Enable",
    Disable: "Disable",
    CreateRoot: "Create item",
    ExportSelected: "Export selected",
    ImportFromFile: "Import from file",
    CreateItemTitle: "Create menu item",
    ...
    LinkType: "Link",
    ButtonType: "Button",
    CustomInterfaceType: "Page",
    CustomInterface: "Page",
    Description: "Description",
    ...
    AddChild: "Add child",
    DeletePrompt: "Delete menu item",
    DeletePromptDescription: "Are you sure you want to delete {{name}}?",
    Unnamed: "Unnamed",
    SystemItem: "System item",
    RouteHelper: "Saved into `options.route` and shown in the table.",
    OptionsJsonError: "Options must be a valid JSON object.",
    TranslationsJsonError: "Translations must be a valid JSON object.",
    AccessJsonError: "Access must be a valid JSON object.",
    SaveError: "Unable to save menu item.",
    ReorderError: "Unable to save menu order.",
    SelectItemsToExport: "Select menu items to export.",
    ExportSelectedSuccess: "Selected menu items exported.",
    ImportSelectedSuccess: "{{count}} menu items imported.",
    ImportSelectedError: "Unable to import menu items.",
    ImportInvalidFile: "Invalid import file.",
    NameTranslationsTitle: "Menu name translations",
    TranslationsLoading: "Loading languages...",
    TranslationsEmpty: "No languages available.",
    TranslationsLoadError: "Unable to load localization languages.",
    ReorderSameLevelOnly: "Items can only be reordered within the same parent level.",
    AddRule: "Add rule",
    AccessBuilderTitle: "{{name}} access",
    AccessBuilderDescription: "Configure access rules using the same properties supported by checkAccess.",
    AccessRulesEmpty: "No access rules added.",
    AccessRulesOr: "or",
    AccessValueType: "Value type",
    AccessBooleanMode: "Boolean",
    AccessUnitListMode: "Unit list",
    AccessValue: "Value",
    AccessTrue: "True",
    AccessFalse: "False",
    AccessYes: "Yes",
    AccessNo: "No",
    AccessUnits: "Units",
    AccessUnitsHelper: "Select one or more units.",
    AccessUnitIds: "Unit IDs",
    AccessUnitIdsHelper: "Comma-separated unit ids, for example `1000002, 1000000042`.",
    AccessStringValueHelper: "String value used directly by checkAccess.",
    AccessUnitRuleAllUsers: "All users",
    AccessUnitRuleMembersOnly: "Members only",
    AccessUnitRuleHeadsOnly: "Heads only",
    AccessRuleLabelIsUserUnitHead: "Is unit head",
    AccessRuleLabel_unitAccess: "Unit membership",
    AccessRuleLabel_userHasUnit: "Has unit",
    AccessRuleLabel_userHasUnitOrChildren: "Has unit or child unit",
    AccessRuleLabel_userDoesNotHaveUnit: "Does not have unit",
    AccessRuleLabel_userHasRole: "Has role",
    AccessRuleLabel_isUnitedUser: "Belongs to at least one unit",
    AccessRuleLabel_userIsAdmin: "Is admin",
    AccessRuleLabel_userIsGod: "Has god access",
    AccessRuleLabel_unitHasAccessTo: "Unit has access to sections",
    AccessRuleLabel_affiliateUnits: "Affiliate units",
    AccessRuleLabel_userHasUnitNotHead: "Has unit and is not head only",
    AccessRuleLabel_isEnabled: "Enabled flag",
    AccessRuleLabel_hideForUnitsHead: "Hide for unit heads",
    AccessRuleLabel_hideForUnit: "Hide for unit",
    AccessRuleLabel_isLegalUser: "Is legal entity",
    AccessRuleLabel_userHasEveryUnit: "Has every unit",
    AccessRuleLabel_custom: "Custom rule",
    AccessPath_navigation_healthcheck_HealthCheckPage: "Healthcheck / Health Check Page",
    AccessPath_navigation_inbox_InboxFilesListPage: "Inbox / Received Documents",
    AccessPath_navigation_process_Process: "Processes / Process",
    AccessPath_navigation_process_UserProcesses: "Processes / User Processes",
    AccessPath_navigation_process_editable: "Processes / Editable",
    AccessPath_navigation_registry_Registry: "Registry / Registry",
    AccessPath_navigation_registry_RegistryPage: "Registry / Registry Page",
    AccessPath_navigation_tasks_ClosedTasks: "Tasks / Closed Tasks",
    AccessPath_navigation_tasks_CreateTaskButton: "Tasks / Create Task Button",
    AccessPath_navigation_tasks_InboxTasks: "Tasks / My Tasks",
    AccessPath_navigation_tasks_UnitClosedTasks: "Tasks / Department Closed Tasks",
    AccessPath_navigation_tasks_UnitInboxTasks: "Tasks / Department Tasks",
    AccessPath_navigation_ui: "UI",
    AccessPath_navigation_users_Units: "Users / Units",
    AccessPath_navigation_users_UserAccessJournal: "Users / User Access Journal",
    AccessPath_navigation_users_UserLoginJournal: "Users / User Login Journal",
    AccessPath_navigation_users_UserOperations: "Users / User Operations",
    AccessPath_navigation_users_Users: "Users / Users",
    AccessPath_navigation_users_editable: "Users / Editable",
    AccessPath_navigation_users_list: "Users / List",
    AccessPath_navigation_workflow_Drafts: "Workflow / Drafts",
    AccessPath_navigation_workflow_MyWorkflow: "Workflow / My Workflow",
    AccessPath_navigation_workflow_Trash: "Workflow / Trash",
    CabinetMenu: "Cabinet Menu",
  },
  ReportListPage: {
    ...
    RenderProcessSuccesed: 'Report based on template created.',
  ...
  DiiaSignForm: {
    ...
    DiiaSignDocuments: 'Signing documents {{taskName}}',
    RenewQR: 'Renew QR Code',
    SigningDataError: 'Error',
  ...
  EnabledMockPage: {
    ...
    mock: 'Mock',
    AddMock: 'Add mock',
    DeleteMockMethod: 'Delete method',
    ErrorCreatingMocks: 'Mock for user {{name}} already exists',
    ChooseUser: 'Choose user',
    ChoseCurrentUser: 'Choose current user',
    ChooseUserDescription: 'For which user do you want to use mocks',
    ChooseUserError: 'You need to choose a user',
  ...
  VerifiedUserInfo: {
    VerifiedUserPartialInfo: 'Partial data from the State Migration Service',
    VerifiedUserFullInfo: 'Full data from the State Migration Service',
    passportInfo: 'Passport series and number',
    idPassportInfo: 'ID card number',
    address: 'Registered place of residence',
    unzr: 'UNZR',
    birthday: 'Date of birth',
    date_birth: 'Date of birth',
    birthdayPlace: 'Place of birth',
    birth_place: 'Place of birth',
    birthdayCountry: 'Country of birth',
    birthdayMessage:
      'For example, Znamianka settlement, Bashtanka district, Mykolaiv region, or Vasylivka city, Zaporizhzhia region. <br /> This is important because different localities in Ukraine may have the same names.',
    gender: 'Gender',
    email: 'Email',
    phone: 'Phone number',
    ipn: 'Tax ID',
    ...
    IdCardNumber: 'Number',
    ChangedData: 'Has your data changed?',
    ChangedDescription:
      'Find out what to do if some of your data has changed',
    FindOut: 'Find out',
    Edit: 'Edit',
    Save: 'Save',
    StreetName: 'Street',
    ...
    Serie: 'Series',
    Number: 'Number',
    AgreeConfirmation: 'Your profile is missing some data',
    AgreeConfirmationText:
      'To continue working in your personal cabinet, please update your profile data.',
    acceptButtonText: 'Understood',
    indexSample: 'Find postcode',
    indexShort: 'Postcode',
    index: 'Postcode',
    apt: 'Apartment number',
    isPrivateHouse: 'private house',
    korp: 'Building section',
    building: 'Building',
    streetErrorText: 'Can only contain Ukrainian letters, hyphen, and space',
    street: 'Street type',
    day: 'Day',
    month: 'Month',
    January: 'January',
    ...
    December: 'December',
    year: 'Year',
    yearErrorText: 'Birth year must be greater than 1900',
    Gender: 'Gender',
    RegionRegister: 'Region, Kyiv city, or Sevastopol city',
    DistrictRegister: 'Locality or district',
    CityRegister: 'Village, settlement, city district',
    passportData: 'Passport data',
    region: 'Region or Kyiv city',
    district: 'Locality or district',
    city: 'Village, settlement, city district',
    ...
    idCardIssuedBy: 'Issued by',
    idCardIssuedByErrorText: 'Must contain 4 digits',
    foreignersDocument: 'Residence permit',
    foreignersDocumentType: 'Select permit type:',
    citizenship: 'Citizenship',
    citizenShip: 'Citizenship',
    citizenShipUkraine: 'Ukraine',
    changeContactInfo: 'You can change your contact information in',
    profileLinkText: 'profile',
    indexErrorText:
      'The postcode does not match the address. Please ensure the postcode is correct.',
    indexErrorTextUnExists:
      'Please make sure the registration address and postcode are entered correctly.',
    noUnzr: 'No UNZR',
    addressTitle: 'Registered place of residence',
    unzrText:
      'UNZR can be found in your ID card or biometric passport, including in the Diia app',
  },
  StringFilterHandler: {
    SearchRegular: 'Searching regular expression',
  },
  SignFilesLimit: {
    SignFilesLimit:
      'Large-volume signing. We recommend using file-key signing',
  },
  GeojsonMap: {
    Chose: 'Select',
    Close: 'Close',
    Delete: 'Delete',
    address: 'Fair location address',
    created_date: 'Record creation date in IAS "Property"',
    created_user: 'Created by in IAS "Property"',
    rental_price: 'Rental price',
    orgnzr_phone_number: 'Phone number of the fair organizer',
    status: 'Status',
    zone_type: 'Trading place type',
    gid_yarm: 'fair guid',
    globalid: 'Trading place identifier',
    goods_type: 'goods_type',
    guid_zone: 'zone guid',
    holder: 'Participant organization',
    holder_edrpou: 'Participant EDRPOU',
    last_edited_date: 'Last update date in IAS "Property"',
    last_edited_user: 'Last updated by in IAS "Property"',
    organizer: 'Name of the fair organizer',
    objectid: 'objectid',
    orgnzr_edrpou: 'EDRPOU of the fair organizer',
    tae_yarm: 'tae_yarm',
    trdunt_number: 'trdunt_number',
    tooltipTextDisable: 'Unavailable for booking',
    tooltipTextActive:
      'Free place matching your selected goods category and available for booking',
    tooltipTextNotActive:
      'Free place that does not match your selected goods category and is not available for booking',
  },
  ScheduleCalendar: {
    EmptyResults: 'Unfortunately, there are no free slots now. Please try again later',
    Close: 'Close',
    Week: 'Week',
    ShowMore: 'Show {{slots}} more slots',
    ShowLess: 'Hide',
    EmptySlotsDay:
      'Unfortunately, there are no free slots to book a visit. Please try again later or check other available dates.',
    Day: 'Day',
    Month: 'Month',
    FreeSlots: '{{count}} appointments',
    ChooseAll: 'Select all',
    ClearAll: 'Clear selection',
    ClearData: 'Clear all selections',
    ShiftChose:
      'To select a period, click the first slot while holding ⇧ Shift, then click the last slot.',
    FetchingActiveSlots: 'Searching for active slots...',
    DisableTitle: '{{slot}} - this slot is already booked',
    applicant: 'Applicant',
    recipient: 'Recipient',
  },
  UserSelect: {
    Name: 'Full name',
    Ipn: 'Tax ID',
    searchPlaceholder: 'User full name or tax ID',
  },
  TextBlock: {
    helper: 'Tip',
  },
