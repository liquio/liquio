...
export default {
  ...
  CabinetMenuPage: {
    ...
    Enable: "Увімкнути",
    Disable: "Вимкнути",
    CreateRoot: "Створити елемент",
    ExportSelected: "Експортувати вибрані",
    ImportFromFile: "Імпортувати з файлу",
    CreateItemTitle: "Створити елемент меню",
    EditItemTitle: "Редагувати {{name}}",
    Parent: "Батьківський елемент",
    RootItem: "Кореневий елемент",
    Order: "Порядок",
    Type: "Тип",
    LinkType: "Посилання",
    ButtonType: "Кнопка",
    CustomInterfaceType: "Сторінка",
    CustomInterface: "Сторінка",
    Description: "Опис",
    ...
    AddChild: "Додати дочірній елемент",
    DeletePrompt: "Видалити елемент меню",
    DeletePromptDescription: "Ви дійсно хочете видалити {{name}}?",
    Unnamed: "Без назви",
    SystemItem: "Системний елемент",
    RouteHelper: "Зберігається в `options.route` і показується в таблиці.",
    OptionsJsonError: "Options має бути коректним JSON-об'єктом.",
    TranslationsJsonError: "Translations має бути коректним JSON-об'єктом.",
    AccessJsonError: "Access має бути коректним JSON-об'єктом.",
    SaveError: "Не вдалося зберегти елемент меню.",
    ReorderError: "Не вдалося зберегти порядок меню.",
    SelectItemsToExport: "Виберіть елементи меню для експорту.",
    ExportSelectedSuccess: "Вибрані елементи меню експортовано.",
    ImportSelectedSuccess: "Імпортовано елементів меню: {{count}}.",
    ImportSelectedError: "Не вдалося імпортувати елементи меню.",
    ImportInvalidFile: "Некоректний файл імпорту.",
    NameTranslationsTitle: "Переклади назви меню",
    TranslationsLoading: "Завантаження мов...",
    TranslationsEmpty: "Немає доступних мов.",
    TranslationsLoadError: "Не вдалося завантажити мови локалізації.",
    ReorderSameLevelOnly: "Елементи можна впорядковувати лише в межах одного рівня.",
    AddRule: "Додати правило",
    AccessBuilderTitle: "{{name}} доступ",
    AccessBuilderDescription: "Налаштуйте правила доступу на основі властивостей, які підтримує checkAccess.",
    AccessRulesEmpty: "Правила доступу не додано.",
    AccessRulesOr: "або",
    AccessValueType: "Тип значення",
    AccessBooleanMode: "Boolean",
    AccessUnitListMode: "Список підрозділів",
    AccessValue: "Значення",
    AccessTrue: "True",
    AccessFalse: "False",
    AccessYes: "Так",
    AccessNo: "Ні",
    AccessUnits: "Підрозділи",
    AccessUnitsHelper: "Виберіть один або кілька підрозділів.",
    AccessUnitIds: "ID підрозділів",
    AccessUnitIdsHelper: "ID підрозділів через кому, наприклад `1000002, 1000000042`.",
    AccessStringValueHelper: "Рядкове значення, яке напряму використовується в checkAccess.",
    AccessUnitRuleAllUsers: "Всі користувачі",
    AccessUnitRuleMembersOnly: "Тільки учасники",
    AccessUnitRuleHeadsOnly: "Тільки керівники",
    AccessRuleLabelIsUserUnitHead: "Є керівником підрозділу",
    AccessRuleLabel_unitAccess: "Належить до підрозділу",
    AccessRuleLabel_userHasUnit: "Належить до підрозділу",
    AccessRuleLabel_userHasUnitOrChildren: "Належить до підрозділу або дочірнього підрозділу",
    AccessRuleLabel_userDoesNotHaveUnit: "Не належить до підрозділу",
    AccessRuleLabel_userHasRole: "Має роль",
    AccessRuleLabel_isUnitedUser: "Належить до хоча б одного підрозділу",
    AccessRuleLabel_userIsAdmin: "Є адміністратором",
    AccessRuleLabel_userIsGod: "Має god-доступ",
    AccessRuleLabel_unitHasAccessTo: "Має доступ до розділів",
    AccessRuleLabel_affiliateUnits: "Афілійовані підрозділи",
    AccessRuleLabel_userHasUnitNotHead: "Має підрозділ і не лише керівник",
    AccessRuleLabel_isEnabled: "Прапорець увімкнення",
    AccessRuleLabel_hideForUnitsHead: "Приховати для керівників підрозділів",
    AccessRuleLabel_hideForUnit: "Приховати для підрозділу",
    AccessRuleLabel_isLegalUser: "Є юридичною особою",
    AccessRuleLabel_userHasEveryUnit: "Має всі підрозділи",
    AccessRuleLabel_custom: "Кастомне правило",
    AccessPath_navigation_healthcheck_HealthCheckPage: "Healthcheck / Сторінка перевірки стану",
    AccessPath_navigation_inbox_InboxFilesListPage: "Вхідні / Отримані документи",
    AccessPath_navigation_process_Process: "Процеси / Процес",
    AccessPath_navigation_process_UserProcesses: "Процеси / Процеси користувача",
    AccessPath_navigation_process_editable: "Процеси / Редагування",
    AccessPath_navigation_registry_Registry: "Реєстр / Реєстр",
    AccessPath_navigation_registry_RegistryPage: "Реєстр / Сторінка реєстру",
    AccessPath_navigation_tasks_ClosedTasks: "Задачі / Архів моїх задач",
    AccessPath_navigation_tasks_CreateTaskButton: "Задачі / Кнопка створення задачі",
    AccessPath_navigation_tasks_InboxTasks: "Задачі / Мої задачі",
    AccessPath_navigation_tasks_UnitClosedTasks: "Задачі / Архів задач відділу",
    AccessPath_navigation_tasks_UnitInboxTasks: "Задачі / Задачі відділу",
    AccessPath_navigation_ui: "Інтерфейс",
    AccessPath_navigation_users_Units: "Користувачі / Підрозділи",
    AccessPath_navigation_users_UserAccessJournal: "Користувачі / Журнал доступів користувача",
    AccessPath_navigation_users_UserLoginJournal: "Користувачі / Журнал входів користувача",
    AccessPath_navigation_users_UserOperations: "Користувачі / Операції користувача",
    AccessPath_navigation_users_Users: "Користувачі / Користувачі",
    AccessPath_navigation_users_editable: "Користувачі / Редагування",
    AccessPath_navigation_users_list: "Користувачі / Список",
    AccessPath_navigation_workflow_Drafts: "Послуги / Чернетки",
    AccessPath_navigation_workflow_MyWorkflow: "Послуги / Замовлені послуги",
    AccessPath_navigation_workflow_Trash: "Послуги / Кошик",
    CabinetMenu: "Меню кабінету",
  },
  ReportListPage: {
