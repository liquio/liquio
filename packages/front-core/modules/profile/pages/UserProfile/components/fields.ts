...
interface FieldsOptions {
  EmailInput: ComponentType<Record<string, unknown>>;
  PhoneInput: ComponentType<Record<string, unknown>>;
  showMiddleName?: boolean;
}

const fields = ({ EmailInput, PhoneInput, showMiddleName = true }: FieldsOptions) => ({
  isLegal: [
    {
      key: 'companyName',
      name: 'company_name',
