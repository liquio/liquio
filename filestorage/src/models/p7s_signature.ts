 ...
 * Signature model.
 */
export class P7sSignatureModel extends Model {
  static singleton: P7sSignatureModel;
   ...
   * @param {string} data.user User.
   */
  async update(id, { p7s, meta, user, folder }: any) {
    // Prepare RAW.
    const signatureToUpdateRaw: any = {
      p7s: this.provider ? '' : p7s,
      meta: meta,
      updated_by: user,
    };
   ...
   * @param {string} data.user User.
   */
  async createOrUpdate({ fileId, p7s, meta = {}, user }: any) {
