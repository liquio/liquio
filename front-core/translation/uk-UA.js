...
export default {
  ...
  WorkflowAdminPage: {
    ...
    'copilotSettings': 'Налаштування ШІ Copilot',
    'copilotModel': 'Модель для генерації коду',
    'copilotModelSample': "Назва моделі ШІ: 'gpt-4', 'gpt-3.5', 'codegen', тощо",
    'copilotEnabled': 'Copilot увімкнено',
    'copilotEnabledSample': 'true — увімкнено, false — вимкнено',
    'copilotTemperature': 'Температура генерації (контроль креативності)',
    'copilotTemperatureSample': '0 — детерміновано, 1 — дуже варіативно',
    'copilotMaxOutputTokens': 'Максимальна кількість вихідних токенів',
    'copilotMaxOutputTokensSample': 'напр. 512, 2048',
    'copilotMaxPrefixLength': 'Максимальна довжина префіксу (контекст перед курсором)',
    'copilotMaxPrefixLengthSample': 'Кількість токенів перед курсором (напр. 1000)',
    'copilotMaxSuffixLength': 'Максимальна довжина суфіксу (контекст після курсора)',
    'copilotMaxSuffixLengthSample': 'Кількість токенів після курсора (напр. 500)',
