...
export class UnitEntity extends Entity {
   ...
   */
  getFilterProperties() {
    return ['id', 'parentId', 'basedOn', 'name', 'description', 'members', 'heads', 'data', 'menuConfig', 'allowTokens', 'requestedMembers'];
  }
  ...
  getFilterPropertiesBrief() {
    return ['id', 'parentId', 'basedOn', 'name', 'description', 'data', 'menuConfig', 'allowTokens'];
  }
