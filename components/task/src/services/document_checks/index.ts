// Imports.
import { DisableCreate } from './checks/disable_create';
 ...
 */
export class DocumentChecks {
  private static singleton: DocumentChecks;
  initializedChecks: any;
  ...
  checkAll(jsonSchema, documentData) {
    ...
    const commonResult: any = { isFailed: false };
