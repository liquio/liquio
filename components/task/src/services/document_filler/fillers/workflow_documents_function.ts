 ...
 */
export class WorkflowDocumentsFunctionFiller extends Filler {
  private static singleton: WorkflowDocumentsFunctionFiller;
  taskModel: any;
  ...
  async fill(schemaObject, objectToFill: any = {}, options: any = {}) {
    ...
    await this.handleAllElements(schemaObject, objectToFill, async (item, itemSchema) => {
      ...
      try {
        ...
        global.log.save('workflow-documents-function-field-filling-error', error, 'warn');
      }
