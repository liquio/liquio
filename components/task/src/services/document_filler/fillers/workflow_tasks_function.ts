 ...
 */
export class WorkflowTasksFunctionFiller extends Filler {
  private static singleton: WorkflowTasksFunctionFiller;
  taskModel: any;
  ...
  async fill(schemaObject, objectToFill: any = {}, options: any = {}) {
    ...
    await this.handleAllElements(schemaObject, objectToFill, async (item, itemSchema) => {
      ...
      try {
        ...
        global.log.save('workflow-tasks-function-field-filling-error', error, 'warn');
      }
