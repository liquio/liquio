...
export class Sandbox {
  ...
  context: any;
  defaultGlobals: any;
  globalFunctionsObject: any;
  isolate: any;
  jail: any;
  sandbox: any;
  workflowTemplateFunctions: any;
  ...
  updateWorkflowTemplateFunctions(workflowTemplateId, globalFunctions: any) {
    ...
    for (const [functionName, functionCode] of pairs as [string, any][]) {
   ...
   * @returns {any} Result.
   */
  evalWithArgs(code, args, options: any = {}) {
 ...
 */
function base64Encode(rawString = '', rawStringEncoding: BufferEncoding = 'utf8') {
