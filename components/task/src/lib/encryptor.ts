...
export class Encryptor {
  ...
  encrypt(data) {
    try {
      ...
      const wrapped: any = new Error(`Error while encrypting data: ${error.message}`);
      wrapped.cause = error;
      throw wrapped;
    }
  }
  ...
  decrypt(packedData) {
    try {
      ...
      const wrapped: any = new Error(`Error while decrypting data: ${error.message}`);
      wrapped.cause = error;
      throw wrapped;
    }
  }
  ...
  unpack(packedData) {
    try {
      ...
      const wrapped: any = new Error(`Error while unpacking: ${error.message}`);
      wrapped.cause = error;
      throw wrapped;
    }
  }
