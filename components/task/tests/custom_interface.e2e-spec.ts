...
describe('CustomInterface Controller', () => {
  let app: TestApp;

  const TEST_USER_ID = '61efddaa351d6219eee0904b';
  ...
  describe('GET /custom-interfaces', () => {
    it('requires auth', async () => {
      await expectAuthRequired(app, 'get', '/custom-interfaces');
    });

    it('returns a list of custom interfaces for an authenticated user', async () => {
