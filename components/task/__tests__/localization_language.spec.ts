...
describe('LocalizationLanguage Controller', () => {
  let app: TestApp;

  const TEST_USER_ID = '61efddaa351d6219eee0904c';
  ...
  describe('GET /localization-languages', () => {
    it('requires auth', async () => {
      await expectAuthRequired(app, 'get', '/localization-languages');
    });

    it('returns a list of localization languages for an authenticated user', async () => {
