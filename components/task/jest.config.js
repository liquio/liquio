...
const config = {
  ...
  // cacheDirectory: "/private/var/folders/92/jrtg0ttx2g7c66p0zrt1jwv00000gn/T/jest_dx",
  ...
  // This is needed because axios/nock interactions can leave open handles
  forceExit: true,
  ...
  // raw-body 4 is ESM-only, so it has to be transformed like our own sources.
  transformIgnorePatterns: ['/node_modules/(?!raw-body/)'],
