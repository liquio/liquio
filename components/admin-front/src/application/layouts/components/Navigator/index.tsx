...
class Navigator extends React.Component<any> {
  constructor(props: any) {
    ...
    if (onlyRegister) {
      storage.setItem('onlyRegister', String(onlyRegister));
    }
  ...
  render() {
    ...
    const categories: any[] = ([] as any[])
      .concat(...(modules as any[]).map((module) => module.navigation || []))
      .sort(prioritySort)
...
(Navigator as any).propTypes = {
  location: PropTypes.object,
  userUnits: PropTypes.array.isRequired,
  userInfo: PropTypes.object.isRequired,
  handleDrawerToggle: PropTypes.func,
};
(Navigator as any).defaultProps = {
  location: { pathname: '' },
  handleDrawerToggle: () => {},
};
...
const styled = withStyles(styles as any)(connect(mapStateToProps)(translated as any) as any);
