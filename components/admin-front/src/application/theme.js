export default {
  ...
  overrides: {
    ...
    MuiButton: {
      root: {
        minWidth: 32,
        '&.MuiButton-outlinedPrimary .MuiButton-startIcon, &.MuiButton-outlinedPrimary .MuiButton-endIcon':
          {
            color: 'inherit'
          },
        '&.MuiButton-outlinedPrimary .MuiButton-startIcon svg, &.MuiButton-outlinedPrimary .MuiButton-endIcon svg':
          {
            fill: 'currentColor'
          }
      },
