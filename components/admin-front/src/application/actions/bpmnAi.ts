...
export const getGreetingMessage = () => (dispatch: Dispatch) =>
  api
    .get(
...
export const getHotActionPrompts = () => (dispatch: Dispatch) =>
  api
    .get(
...
export const getAiPrompts = (body: unknown, mode: string) => (dispatch: Dispatch) => {
...
export const getAiSessionId = (body: unknown) => (dispatch: Dispatch) =>
  api
    .post(
...
export const getBuilderSessionId = (body: unknown) => (dispatch: Dispatch) =>
  api
    .post(
...
export const getAiChatHistory = (sessionId: string | number) => (dispatch: Dispatch) =>
  api
    .get(
...
export const getAiBuilderHistory = (sessionId: string | number) => (dispatch: Dispatch) =>
  api
    .get(
...
export const deleteAssistantChatHistory = (sessionId: string | number) => (dispatch: Dispatch) =>
  api
    .del(
      `${BPMN_AI_PROXY_ROUTE}/ai-helper/assistant/sessions/${sessionId}`,
      {},
...
export const deleteCodeGenerationChatHistory = (sessionId: string | number) => (dispatch: Dispatch) =>
  api
    .del(
      `${BPMN_AI_PROXY_ROUTE}/builder/code/sessions/${sessionId}`,
      {},
...
export const sendAiAnomaliesAnalyze = (body: unknown) => (dispatch: Dispatch) =>
  api
    .post(
...
export const generateTechSpecBySchema = (body: unknown) => (dispatch: Dispatch) =>
  api
    .post(
...
export const sendExternalCommand = (externalCommand: unknown) => ({
