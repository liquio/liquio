...
export const storeTaskDocument =
  ({ task, data, params }: { task: { documentId: string | number }; data: unknown; params: string }) =>
  (dispatch: Dispatch) =>
    api
      .put(
...
export const getTaskDocumentP7SSignData =
  (documentId: string | number, attachmentId?: string | number) => (dispatch: Dispatch) => {
...
export const signTaskDocument = (documentId: string | number, signature: unknown) => (dispatch: Dispatch) =>
  api
    .post(
...
export const signTaskDocumentP7S =
  (documentId: string | number, p7sSignature: unknown, attachmentId?: string | number) => (dispatch: Dispatch) => {
    let url = `documents/${documentId}/sign_p7s`;
...
export const generatePDFDocument = (documentId: string | number) => (dispatch: Dispatch) =>
  api
...
export const uploadDocumentAttach = (documentId: string | number, file: File, labels: unknown) => (dispatch: Dispatch) =>
  api
    .upload(
...
export const downloadDocumentAttach =
  ({ documentId, id }: { documentId: string | number; id: string | number }, asics = false) =>
  (dispatch: Dispatch) =>
    api
      .get(
...
export const externalReaderCheckData = (documentId: string | number, body: unknown) => (dispatch: Dispatch) =>
  api
    .post(
...
export const validateDocument = (documentId: string | number) => (dispatch: Dispatch) =>
  api
