...
const UserAccessJournalPage = ({ t, title, location }) => {
...
const modulePage = asModulePage(UserAccessJournalPage);
export default translate('UserAccessJournalPage')(modulePage);
