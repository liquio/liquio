...
type ModalType = 'create-child' | 'access' | 'edit' | 'delete' | null;

interface CabinetMenuActionsProps {
...
const CabinetMenuActions = ({
  ...
  const canCreateChild = !item?.parentId && ((item?.depth as number) || 0) === 0;
