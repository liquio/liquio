...
interface ExportRegistryDialogProps {
  register: RegisterItem;
  open: boolean;
  onClose: () => void;
}

export const ExportRegistryDialog = ({ register, open, onClose }: ExportRegistryDialogProps) => {
  ...
  const handleExport = useCallback(async () => {
    ...
    try {
      ...
      addMessage(new Message('FailExportingRegisters', 'error', (e as Error).message) as never);
    }
  ...
  return (
    <Dialog
      ...
      fullWidth={true}
    >
      <DialogTitle>{t('ExportRegisterTitle', register as never)}</DialogTitle>
      <RegisterKeyTable
        busy={busyOrLoading}
        setBusy={setBusy}
        register={register}
