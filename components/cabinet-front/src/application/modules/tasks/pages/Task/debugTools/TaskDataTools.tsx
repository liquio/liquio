...
class TaskDataTools extends React.Component<any, any> {
...
(TaskDataTools as any).propTypes = {
  classes: PropTypes.object.isRequired,
  task: PropTypes.object.isRequired,
  template: PropTypes.object.isRequired
};

export default withStyles(styles as any)(TaskDataTools as any);
