...
const PopupCheckValidTools = ({ classes, rootDocument, data, schema, pageData }: any) => {
  ...
  propertiesEach(schema, data, (propSchema: any, propData: any, path: any, parentSchema: any, parentData: any, key: any) => {
    key &&
      elements.push({
        schema: propSchema,
        data: propData,
  ...
  const handleChange = (value: any, el: any) => {
    setFunc(value);
    setElement(el);
  };
