...
const LegacyStoreEventError = StoreEventError as React.ComponentType<any>;
const LegacyImportActions = ImportActions as React.ComponentType<any>;
const LegacyTimer = Timer as React.ComponentType<any>;
...
const EditScreenLayout = ({
  ...
  const subtitle: any = result instanceof Error ? description : result;
  ...
  return (
    <DrawerContent
      ...
      collapseButton={true}
      drawer={
        checkAccess({ isUnitedUser: true }, null as any, userUnits) && !isEntry ? (
          <TaskDetails task={task} template={template} isUserUnitHead={isUserUnitHead} />
        ) : null
      }
    >
      <div className={classes.drawer}>
        <LegacyStoreEventError error={storeEventError} onClose={() => setStoreEventError(null)} />
        <div className={classes.content}>
          <Content>
            <LegacyImportActions handleImport={handleImport} importSchema={jsonSchema.importSchema} />
            ...
            <SchemaStepper
              ...
              handleStep={(step: number) => handleSetStep(step)}
            ...
            {validationPageErrors.length ? (
              <div>
                <FormControl error={true} className={classes.root}>
                  {validationPageErrors.map((error: any, index: number) => (
