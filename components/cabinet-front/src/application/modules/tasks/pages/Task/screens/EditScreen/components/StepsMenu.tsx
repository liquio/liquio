...
const StepsMenu = ({
  ...
  const getTitle = (string: string, data: any): any => {
  ...
  const checkStepOnNavigating = (stepsArray: string[]): string[] => {
    const filtered = stepsArray.filter((stepId: string) => {
  ...
  const renderList = (
    ...
    >
      <Scrollbar options={{ suppressScrollX: true }}>
        {steps.map((stepId: string, index: number) => {
