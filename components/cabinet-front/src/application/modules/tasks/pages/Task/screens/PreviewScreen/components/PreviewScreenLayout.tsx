...
const PreviewScreenLayout = ({
  ...
  const handleDownloadPdf = React.useCallback(() => {
    ...
    (attachments || [])
      .filter(({ isGenerated }: any) => isGenerated)
  ...
  return (
    <div className={classes.taskPreviewContainer}>
      <LegacyStoreEventError error={storeEventError} />
      <DrawerContent
        disableScrolls={true}
        drawer={
...
const mapStateToProps = ({
  ...
  task: { documents }
}: any) => ({ authInfo: info, pdfDocuments, documents, fileList: list });
...
const translated = translate('TaskPage')(withStyles(styles as any)(PreviewScreenLayout as any) as any);
