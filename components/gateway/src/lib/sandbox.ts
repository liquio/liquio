...
export class Sandbox {
  ...
  updateWorkflowTemplateFunctions(workflowTemplateId: string | number, globalFunctions: Record<string, any>) {
   ...
   * @returns {any} Result.
   */
  evalWithArgs(code: string | undefined, args: any[] | undefined, options: any = {}): any {
