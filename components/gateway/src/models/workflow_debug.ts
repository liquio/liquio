...
import { WorkflowDebugEntity } from '../entities/workflow_debug';

export class WorkflowDebugModel extends Model {
  static singleton: WorkflowDebugModel;
  model: any;
   ...
   */
  async create({ id, workflowId, serviceName, data }: any): Promise<void> {
   ...
   */
  async findById(id: number): Promise<WorkflowDebugEntity | undefined> {
   ...
   */
  async getAllByWorkflowId(workflowId: string): Promise<WorkflowDebugEntity[]> {
   ...
   */
  prepareEntity(item: any): WorkflowDebugEntity {
