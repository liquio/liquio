 ...
 * Signature entity.
 */
export class P7sSignatureEntity extends Entity {
  id: number;
  fileId: string;
  p7s: string;
  meta: any;
   ...
   */
  constructor({ id, file_id, p7s, meta, created_by, updated_by, created_at, updated_at, folder }: any) {
   ...
   */
  static getP7sFileName(fileName: string) {
