 ...
 * Registers requester.
 */
export class RegistersRequester {
  static singleton: RegistersRequester;
  ...
  constructor(config: any) {
    ...
    if (!RegistersRequester.singleton) {
      this.provider = new (RegistersRequester.ProvidersList as any)[config.provider](config);
   ...
   */
  async saveRecordsToCsv(data: any, eventContext: any): Promise<any> {
   ...
   */
  async getRecords(data: any, eventContext: any): Promise<any> {
   ...
   */
  async countRecords(data: any, eventContext: any): Promise<any> {
   ...
   */
  async getKeyById(id: string, eventContext: any): Promise<any> {
