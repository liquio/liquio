 ...
 */
export class DecoratorTrembita extends Decorator {
  /**
   * Transform.
   ...
   */
  async getFileFromEvent(filestorage: any, eventModel: any, workflowId: any, eventTemplateId: any): Promise<any> {
    // Get workflow events.
  ...
  async checkOptions(
    ...
    document: any,
    dataObject: any,
    dataObjectForLog: any,
    sendFileFromEvent: any,
    filestorage: any,
    eventModel: any,
    workflowId: any,
  ): Promise<any> {
   ...
   * @return {string}
   */
  fillSoapMessage(dataBase64: any, documentId: any, timestamp: any, workflowId: any, service: any): string {
   ...
   */
  getTrembitaConfig(service: any): any {
    const {
      requester: {
        externalService: {
