...
import { WorkflowTemplateTagEntity } from '../entities/workflow_template_tag';

export class WorkflowTemplateTagModel extends Model {
  static singleton: WorkflowTemplateTagModel;
