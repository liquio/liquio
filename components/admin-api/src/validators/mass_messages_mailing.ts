...
/**
 * Mass messages mailing validator.
 */
export class MassMessagesMailingValidator extends Validator {
  static singleton: MassMessagesMailingValidator;

  /**
   * Mass messages mailing validator constructor.
   */
