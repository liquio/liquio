 ...
 */
export class WorkflowTemplateCategoryController extends Controller {
  private static singleton: WorkflowTemplateCategoryController;

  workflowTemplateCategoryModel: any;
