...
import { SignatureRemovalHistoryEntity } from '../entities/signature_removal_history';

export class SignatureRemovalHistory extends Model {
  static singleton: SignatureRemovalHistory;
