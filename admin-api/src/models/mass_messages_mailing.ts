...
import { MassMessagesMailingEntity } from '../entities/mass_messages_mailing';

export class MassMessagesMailingModel extends Model {
  static singleton: MassMessagesMailingModel;
