...
import { LocalizationLanguageEntity } from '../entities/localization_language';
import { SequelizeDbError, SequelizeUniqueConstraintError } from '../lib/errors';

/**
 * Localization language model.
 */
export class LocalizationLanguageModel extends Model {
  static singleton: LocalizationLanguageModel;
