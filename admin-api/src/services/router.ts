...
import { BpmnWorkflowController } from '../controllers/bpmn_workflow';
import { WorkflowLogController } from '../controllers/workflow_log';
import { WorkflowStatusController } from '../controllers/workflow_status';
import { WorkflowController } from '../controllers/workflow';
import { WorkflowProcessController } from '../controllers/workflow_process';
import { WorkflowTagController } from '../controllers/workflow_tag';
import { TaskController } from '../controllers/task';
import { EventTypeController } from '../controllers/event_type';
import { EventController } from '../controllers/event';
import { GatewayTypeController } from '../controllers/gateway_type';
import { GatewayController } from '../controllers/gateway';
import { WorkflowCategoryController } from '../controllers/workflow_category';
import { UnitController } from '../controllers/unit';
import { UnitAccessController } from '../controllers/unit_access';
import { NumberTemplateController } from '../controllers/number_template';
import { CustomLogController } from '../controllers/custom_log';
import { AccessHistoryController } from '../controllers/access_history';
import { LoginHistoryController } from '../controllers/login_history';
import { UserAdminActionController } from '../controllers/user_admin_action';
import { UIFilterController } from '../controllers/ui_filter';
import { CustomInterfaceController } from '../controllers/custom_interface';
import { ProxyItemController } from '../controllers/proxy_item';
import { MessageTemplateController } from '../controllers/message_template';
import { SqlReportsController } from '../controllers/sql_reports';
import { StatController } from '../controllers/stat';
import { FavoritesController } from '../controllers/favorites';
import { SnippetsController } from '../controllers/snippets';
import { AssetsController } from '../controllers/assets';
import { MassMessagesMailingController } from '../controllers/mass_messages_mailing';
