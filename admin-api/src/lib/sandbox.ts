...
export class Sandbox {
  ...
  public config: any;
  public globalFunctionsObject: string;
  public defaultGlobals: object;
  public workflowTemplateFunctions: object;
  private isolate: vm.Isolate;
